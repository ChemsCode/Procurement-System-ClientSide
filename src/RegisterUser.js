...
const NAME_REGEX = /^([a-zA-Z0-9]+|[a-zA-Z0-9]+\s{1}[a-zA-Z0-9]{1,}|[a-zA-Z0-9]+\s{1}[a-zA-Z0-9]{3,}\s{1}[a-zA-Z0-9]{1,})$/;
...
const RegisterUser = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    console.log(userName, companyEmail, pwd);
    setSuccess(true);
  ...
  return (
    <section>
      ...
      <form onSubmit={handleSubmit}>
        ...
        <button
          disabled={!validUserName || !validCompanyEmail || !validPwd || !validMatch ? true : false}
        >
          Sign Up
        </button>
      </form>
